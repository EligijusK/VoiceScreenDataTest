...
class_model, path_model_class, path_settings_class, path_checkpoint_class, path_model_index, path_settings_index, path_checkpoint_index, fpath, opath = sys.argv[1:]
